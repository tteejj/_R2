...
class KeybindingService {
    ...
    [void] PushContext([string]$context) {
        if (-not [string]::IsNullOrWhiteSpace($context)) {
            ...
            Write-Log -Level Debug -Message "Pushed keybinding context: $context" -Component "KeybindingService"
        }
    }
    ...
    [string] PopContext() {
        if ($this.ContextStack.Count -gt 0) {
            ...
            Write-Log -Level Debug -Message "Popped keybinding context: $context" -Component "KeybindingService"
            return $context
        }
        return $null
    }
